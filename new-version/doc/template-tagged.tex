...
\includegraphics[width=12.5cm, 
                 alt={Scientific diagram showing the electromagnetic spectrum from gamma rays to radio waves, with visible light highlighted in the middle}]{logo-mdpi}
...
\includegraphics[width=4.0 cm]{logo-mdpi}
...
\subfloat[\centering]{\includegraphics[width=7.0cm]{logo-mdpi}}
%\hfill
\subfloat[\centering]{\includegraphics[width=7.0cm]{logo-mdpi}}\\
\subfloat[\centering]{\includegraphics[width=7.0cm]{logo-mdpi}}
%\hfill
...
%\startlandscape %% When switch LuaLaTeX, this command doesn't work, how to solve this problem?
