...
\DocumentMetadata
 {
   tagging = on,           % Enable tagged PDF
%  lang = en-US,             % Document language (American English)
%  pdfstandard = ua-2,       % PDF/UA-2 accessibility standard
  tagging-setup = {math/setup={mathml-SE}} % Convert math to MathML
 }

\documentclass[acoustics,article,accept,moreauthors]{mdpi-luatex} 
%\documentclass[preprints,article,submit,moreauthors]{mdpi-luatex} 
...
\Author{Firstname Lastname \textsuperscript{1}\orcidA{}, Firstname Lastname \textsuperscript{2} and Firstname Lastname \textsuperscript{2,}*}
...
\address{%
\textsuperscript{1} \quad Affiliation 1; e-mail@e-mail.com\\
\textsuperscript{2} \quad Affiliation 2; e-mail@e-mail.com}
...
\textbf{What are the main findings?}
 \begin{itemize}[labelsep=2.5mm,topsep=-3pt,end-vspace=0pt]
 \item First bullet.
 \item Second bullet.
 \end{itemize}
...
%% For test fi-ligature problem:
In another study, \citeauthor{ref-proceeding} (\citeyear{ref-proceeding}) examined the effectiveness of the concept mapping technique to measure students’ systems thinking within the context of science education. The participants of their study were primary and secondary students and they found that computer-based concept mapping is an appropriate tool to make large scale assessments in systems~thinking.
...
All figures and tables should be cited in the main text as Figure~\ref{fig1}, Table~\ref{tab1}, etc. Just for test \fig{fig1}, \cref{fig1,fig2}

\begin{figure}[H]
%\isPreprints{\centering}{} % Only used for preprints
\includegraphics[width=8.0 cm,alt={This is an alt text test.}]{logo-mdpi}
...
\subfloat[\centering]{\includegraphics[width=7.0cm,alt={This is an alt text test.}]{logo-mdpi}}
%\hfill
\subfloat[\centering]{\includegraphics[width=7.0cm,alt={This is an alt text test.}]{logo-mdpi}}\\
\subfloat[\centering]{\includegraphics[width=7.0cm,alt={This is an alt text test.}]{logo-mdpi}}
%\hfill
\subfloat[\centering]{\includegraphics[width=7.0cm,actualtext={This is an alt text test.}]{logo-mdpi}}
%\isPreprints{}{% This command is only used for ``preprints''.
\end{adjustwidth}
%} % If the paper is ``preprints'', please uncomment this parenthesis.
