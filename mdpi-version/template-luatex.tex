...
\documentclass[acoustics,article,accept,moreauthors]{Definitions/mdpi-luatex} 
...
\includegraphics[width=12.5cm, 
                 alt={Scientific diagram showing the electromagnetic spectrum from gamma rays to radio waves, with visible light highlighted in the middle}]{Definitions/logo-mdpi.eps}
