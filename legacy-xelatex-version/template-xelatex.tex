...
%=================================================================
\documentclass[religions,article,accept,moreauthors]{Definitions/mdpi-xelatex} 
%\documentclass[preprints,article,submit,pdftex,moreauthors]{Definitions/mdpi} 
% For posting an early version of this manuscript as a preprint, you may use "preprints" as the journal. Changing "submit" to "accept" before posting will remove line numbers.

% Below journals will use APA reference format:
% admsci, behavsci, businesses, econometrics, economies, education, ejihpe, games, humans, ijfs, jintelligence, journalmedia, jrfm, languages, psycholint, publications, tourismhosp, youth
...
%\IsAssociation{yes} % For society journal, please put society logo in Folder Definitions
...
\Title{Title \RL{\arabicfont  انا صينية}}
...
\section{How to {\arabicfont  انا صينية} Use this Template \textarabic{انا صينية} {\arabicfont  انا صينية}}

\subsection{\texthebrew{זה משפט בעברית.} How to {\arabicfont  انا صينية} Use this Template \textarabic{انا صينية} {\arabicfont  انا صينية}}

The Hebrew words example:  {\foreignlanguage{hebrew}{םשרוקיתא}} or 
\texthebrew{זה משפט בעברית.}\endnote{{\foreignlanguage{hebrew}{םשרוקיתא}}}

{\it\foreignlanguage{hebrew}{םשרוקיתא}}
...
\texthebrew{זה משפט בעברית זה משפט בעבריתזה משפט בעבריתזה משפט בעבריתזה משפט בעבריתזה משפט בעבריתזה משפט בעברית}

{\hebrewfont אני סיני}

\RL{\hebrewfont אני סיני}

{\arabicfont  انا صينية}

\textarabic{انا صينية}

\RL{\arabicfont  انا صينية}

% Special Cyrillic
\textit{{\rufont Βυζαντινές Τοιχογραφίες Матильда}}

{\rufont Βυζαντινές Τοιχογραφίες Матильда}

%\palatinofont
%If you want to add Hebrew words, please use same mothod to implement.

{\rmfont The template details}
...
\includegraphics[width=6 cm]{Definitions/logo-mdpi}
...
\end{table}
\section{How to {\arabicfont  انا صينية} Use this Template \textarabic{انا صينية} {\arabicfont  انا صينية}}
\subsection{How to {\arabicfont  انا صينية} Use this Template \textarabic{انا صينية} {\arabicfont  انا صينية}}
\section[\appendixname~\thesection]{}
